...
public class AndroidCallgraph {
    ...
    public static void main(String[] args){
        ...
        Map<SootMethod, SootMethod> reachableParentMap = getAllReachableMethods(mainActivityEntryMethod);
        if(reachableParentMap.containsKey(childMethod))
            System.out.println("childMethod is reachable from MainActivity, a possible path: " + getPossiblePath(reachableParentMap, childMethod));
        else
            System.out.println("childMethod is not reachable from MainActivity.");
        if(reachableParentMap.containsKey(parentMethod))
            System.out.println("parentMethod is reachable from MainActivity, a possible path: " + getPossiblePath(reachableParentMap, parentMethod));
